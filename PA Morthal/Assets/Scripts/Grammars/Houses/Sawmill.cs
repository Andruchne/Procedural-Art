            ...
            case 1:
                {
                    for (int i = 0; i < 3; i++)
                    {
                        ...
                        for (int a = 0; a < buildLength; a++)
                        {
                            if (a > 0)
                            {
                                SpawnPrefab(blockCollection.unsnowedGroundPlank,
                                    new Vector3(centerMargin, 0, currentPos), Quaternion.Euler(0, 90, 0));
                                ...
                                if (i == 0)
                                {
                                    ...
                                    {
                                        GameObject watermill = SpawnPrefab(blockCollection.watermill,
                                        new Vector3(centerMargin + 1, -0.5f, currentPos + 0.5f), Quaternion.Euler(0, 0, 0));
                                        watermill.transform.localScale = new Vector3(1.5f, 1.5f, 1.5f);
                                    }
                                }
                                else if (i == 1)
                                {
